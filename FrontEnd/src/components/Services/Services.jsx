...
//         <button onClick={handleSubmit} disabled={!imageFile} className={`bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded shadow-md ${loading || !imageFile ? 'opacity-50 cursor-not-allowed' : ''}`}>
