const ProfileCards = ({ name, description, image, twitter, linkedin, github, post }) => {
    return (
      <div className="w-full group min-h-screen flex justify-center items-center bg-cover bg-fixed bg-center bg-no-repeat rounded-t-2xl  ">
        <div className="w-96 bg-base-100 shadow-xl">
          ...
          <div className="w-full text-center card-body">
            <div className="flex justify-center pt-8 pb-0 lg:pt-4">
              <div className="flex space-x-2">
                <a className="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary" href={twitter}
                ...
                <a className="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary" href={github}
                ...
                <a className="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary" href={linkedin}
...
//          <div>
//        <div className='flex items-center justify-center min-h-screen from-gray-700 via-gray-800 to-gray-900 md:w-80 overflow-none'>
...
//            <div className="pb-6">
            ...
            //        <div className="flex justify-center w-full">
            //            <div className="relative">
            //                <img src={image} className="dark:shadow-xl border-white dark:border-gray-800 rounded-full align-middle border-8 absolute -m-16 -ml-18 lg:-ml-16 max-w-[150px]" />
            //            </div>
            //        </div>
            //    </div>
//                <div className="mt-2  text-center">
                ...
                //        <div className="text-sm font-bold tracking-wide text-gray-600 dark:text-gray-300 font-mono text-xl">{post}</div>
            ...
            //                    <a className="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary" 
                                //  href={github} 
                                //  // rel="noopener noreferrer" 
                                //  aria-label="" 
                                //  // target="_blank"
